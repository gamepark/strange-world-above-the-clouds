...
use [our template on GitHub](https://github.com/gamepark/board-strange-world-above-the-clouds)
...
- `StrangeWorldAboveTheClouds` => `NameOfYourGame`
- `strange-world-above-the-clouds` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [StrangeWorldAboveTheCloudsRules.ts](/rules/src/StrangeWorldAboveTheCloudsRules.ts)
...
rclone config
> n (For "New remote)
name> strange-world-above-the-clouds
